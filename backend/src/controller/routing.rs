...
use super::{
    experiment_controller::{
        ...
        patch_experiment_pipeline, post_experiment_pipeline_variable, post_execute_experiment, get_experiment_execution_status, post_experiment_abort,
    },
...
pub fn routing_config(cfg: &mut ServiceConfig) {
    ...
    .route("/api/experiments/{id}/abort", web::post().to(post_experiment_abort))
